...
import { footerExploreLinks, footerSupportLinks } from "../constant/db";
const Footer = () => {
  return (
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-10">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="text-gray-300 mb-6 max-w-md">
              ...
              purchasing books from around the world. We bring stories to life
              and connect readers with their next favorite book.
            </p>
